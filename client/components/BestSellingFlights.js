...
"
                    className="mt-4 inline-flex items-center justify-center gap-2 bg-primary-red text-white font-semibold px-4 py-2 rounded-[8px_0_8px_0] hover:bg-primary-blue transition"
                  >
                    Book Now
                  </a>
                </div>
...
"
          >
            <button className="w-full bg-primary-red text-white py-3 rounded-[8px_0_8px_0] font-semibold hover:bg-primary-blue transition duration-300 shadow-lg animate-pulse cursor-pointer">
              Find My Flight
            </button>
          </a>
        </div>
