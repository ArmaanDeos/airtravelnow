      ...
      <div className="relative z-10 space-y-10 mt-20 px-4">
        ...
        <Card className="bg-gray-900/30 text-white">
          <CardContent className="p-6 space-y-6">
            ...
            <p>
              At Airtravelnow, we are proud to offer an exceptional travel
            ...
            <p>
              The world is waiting for you, and Airtravelnow is here to take you
              there. Let us handle the details so you can enjoy every moment of
              your journey. Whether you’re looking for a family vacation, a solo
              trip, or a group adventure, our team is ready to turn your dreams
              into a reality.
            </p>
...
"
              ...
              >
                Call Us: 0800 058 4202
              </a>
              <a
                href="mailto:info@Airtravelnow.online"
                className="bg-primary-blue text-white py-2 px-4 rounded-md hover:bg-primary-red transition duration-200"
              >
                Email Us: info@Airtravelnow.online
              </a>
            </div>
          </CardContent>
        </Card>
