    ...
    <div className="relative bg-gray-950 text-white py-20 px-6 md:px-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 z-10 relative mt-20">
        ...
        <div className="space-y-10">
          <div>
            <h2 className="text-4xl font-extrabold text-primary-red mb-4">
          ...
          <div className="space-y-4 text-base">
            ...
            <div className="flex items-start gap-4">
              ...
              <span>871 Cherry Court, SOUTHAMPTON, S163 5PD , UK</span>
            </div>
            <div className="flex items-start gap-4">
              <Mail className="text-primary-red w-6 h-6 mt-1" />
              <span>info@Airtravelnow.online</span>
            </div>
          </div>
        ...
        <div className="space-y-8 w-full">
          ...
          >
            ...
            <button
              type="submit"
              className="inline-flex items-center gap-2 bg-primary-blue text-white px-6 py-2 rounded-full hover:bg-primary-red transition"
            >
