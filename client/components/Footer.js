        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="flex flex-col gap-4">
              <Image
                src="/images/red-umb/logo-dark.png"
                alt="Logo"
                width={100}
                height={40}
              />
            ...
            <div className="flex flex-col gap-3 text-sm text-gray-300">
              ...
              <p className="flex items-center gap-2 hover:text-primary-red transition-colors">
                <MapPin className="w-4 h-4 text-primary-red" />
                871 Cherry Court, SOUTHAMPTON, S163 5PD , UK
              </p>
              <p className="flex items-center gap-2 hover:text-primary-red transition-colors">
          ...
          <div className="mt-12 text-sm text-gray-400 text-center space-y-2 border-t border-gray-700 pt-6">
            <p className="text-white">
              <strong>Airtravelnow</strong> bearing Registration No.{" "}
              <strong>10843049</strong>, is located at , 871 Cherry Court,
              SOUTHAMPTON, S163 5PD , UK
            </p>
            <p className="text-white">
              All users are subject to Airtravelnow{" "}
              <Link
            ...
            <p className="text-white">
              ...
              <span className="font-medium">Airtravelnow</span>. All rights
              reserved.
            </p>
          </div>
        </div>
