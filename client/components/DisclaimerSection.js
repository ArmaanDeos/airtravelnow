    ...
    <div className="relative min-h-screen bg-gray-950 text-white p-6 md:p-12">
      ...
      <div className="relative z-10 space-y-10 mt-20 px-4">
        <h1 className="text-4xl font-bold mb-4 text-center text-white">
          AirTravelNow Discount Policy & Disclaimer
        </h1>

        <Card className="bg-gray-900/30 text-white">
          <CardContent className="p-6 space-y-6">
            <h2 className="text-2xl font-semibold mt-8 mb-4">
              AirTravelNow Discount Policy
            </h2>

            <p>
              At AirTravelNow, we strive to ensure that all the information
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">
              AirTravelNow Disclaimer
            </h2>

            <p>
              In line with the Terms & Conditions of AirTravelNow, we
            ...
            <p>
              The offers listed on AirTravelNow are subject to change based
            ...
            <ul className="space-y-2">
              ...
              <li>
                AirTravelNow is not liable for any inaccuracies in the data
