    ...
    <div className="relative min-h-screen bg-gray-950 text-white p-6 md:p-12">
      ...
      <div className="relative z-10 space-y-10 mt-20 px-4">
        <h1 className="text-4xl font-bold mb-4 text-center text-white">
          AirTravelNow Holidays – Terms & Conditions
        </h1>

        <Card className="bg-gray-900/30 text-white">
          <CardContent className="p-6 space-y-6">
            <p>
              Welcome to AirTravelNow By using our website
              (https://AirTravelNow.online), mobile site, or app, you&apos;re
            ...
            <p>
              ...
              or “us,” we’re talking about AirTravelNow . When we say “you,”
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p>
                    ...
                    required. AirTravelNow Holidays is not responsible for
