    ...
    <div className="relative min-h-screen bg-gray-950 text-white p-6 md:p-12">
      ...
      <div className="relative z-10 space-y-10 mt-20 px-4">
        <h1 className="text-4xl font-bold mb-4 text-center text-white">
          AirTravelNow – Refund Policy
        </h1>

        <Card className="bg-gray-900/30 text-white">
          <CardContent className="p-6 space-y-6">
            <p className="mb-4">
              At <strong>AirTravelNow</strong>, we strive to process refunds
            ...
            <p className="mb-4">
              AirTravelNow may deduct a nominal service fee from the total
            ...
            <p className="mb-4">
              ...
              flight option. AirTravelNow will facilitate the refund as per
