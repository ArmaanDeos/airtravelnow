    ...
    <div className="relative min-h-screen bg-gray-950 text-white p-6 md:p-12">
      ...
      <div className="relative z-10 space-y-10 mt-20 px-4">
        <h1 className="text-4xl font-bold mb-4 text-center text-white">
          AirTravelNow – Price Match Promise
        </h1>

        <Card className="bg-gray-900/30 text-white">
          <CardContent className="p-6 space-y-6">
            <p className="mb-4">
              At AirTravelNow, we’re committed to helping you secure the best
            ...
            <p className="mb-4">
              ...
              or call us at <strong>0800 058 4202</strong> within 24 hours of
              your booking.
            </p>
            <p className="mb-4">Please include:</p>
            <ul className="list-disc pl-5 mb-4">
              <li>Your AirTravelNow booking reference number</li>
