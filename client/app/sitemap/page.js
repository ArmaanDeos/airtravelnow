...
export default function Sitemap() {
  return (
    <div className="min-h-screen max-w-4xl mx-auto flex flex-col items-center justify-center bg-gray-100 p-5">
      ...
      <Head>
        <title>Website Sitemap | AirTravelNow Travels</title>
        <meta
          name="description"
          content="A structured sitemap of all pages available on AirTravelNow Travels for better navigation and SEO."
        />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="AirTravelNow Travels Team" />
        <meta
          name="keywords"
          content="sitemap, website pages, SEO, structured data, travel site"
        />
        <link rel="canonical" href="https://Airtravelnow.online/" />
      </Head>
